...
public class PlayerInteractions : MonoBehaviour
{
    ...
    [HideInInspector] public bool Dialoguing;
    private PlayerInputs _input;
    private void Start() => _input = GetComponent<PlayerInputs>();
    private void Update()
    {
        // preventing interaction code to overlap the dialogue
        if (!Dialoguing)
        {
        ...
        {
            // Code to deal with dialogues...
            _interactionText.text = $"Received text...";
        }
    }
}